...
plot_df <- unemployment_lagged_term |>
  ...
  dplyr::select(Filed.week.ended, 
                Observed = Initial.Claims.Rate, Fitted) |>
...
All analyses were conducted in R [@R_language]. Data wrangling and date handling used dplyr, tidyr, and lubridate. Visualizations were created using ggplot2. Model estimation and diagnostics used stats, glmnet, MASS, car, and DescTools.
